...
import { easelOutline, informationCircleOutline, keyOutline, personCircleOutline, } from 'ionicons/icons';
    ...
    <IonPage>
      ...
      <IonContent className='ion-padding'>
        <div style={{ textAlign: 'center', marginBottom: '10px' }}>
          <IonIcon icon={informationCircleOutline} style={{ fontSize: '70px' }} />
        </div>
        <IonItem>
